...
const DonationDetails = () => {
    ...
    return (
        ...
        <img src={donate.picture} alt="" className="object-cover object-center w-full rounded-t-md h-[500px] dark:bg-gray-500" />
        <div className="flex flex-col justify-between p-6 space-y-8">
            <div className="space-y-2">
                <h2 className="text-3xl font-semibold tracking-wide">{donate.title}</h2>
                <p className="dark:text-gray-800">{donate.description}</p>
            </div>
            <div>
